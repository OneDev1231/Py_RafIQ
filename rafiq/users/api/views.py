...
class UserViewSet(RetrieveModelMixin, ListModelMixin, UpdateModelMixin, GenericViewSet):
    ...
    def list(self, request, *args, **kwargs):
        return getPagination(self.queryset,request,self.serializer_class,True)
    ...
    @action(detail=False)
    def get_new_signups(self, request):
        today = date.today()
        queryset = self.queryset.filter(userprofile__created_at__date=today)
